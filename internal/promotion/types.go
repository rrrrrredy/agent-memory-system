...
const (
	ApproverKindCallerAttestation = "caller_attestation"
	ApproverKindSyntheticTest     = "synthetic_test"
	ApproverKindLegacyHuman       = "human"
)
...
func ValidApproverKind(kind string) bool {
	switch kind {
	case ApproverKindCallerAttestation, ApproverKindSyntheticTest, ApproverKindLegacyHuman:
		return true
	default:
		return false
	}
