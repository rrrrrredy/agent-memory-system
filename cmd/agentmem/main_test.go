...
func TestDeriveCommandDispatchAndRequiredFlags(t *testing.T) {
	tests := []struct {
		...
		{name: "missing eval subcommand", args: []string{"eval"}, message: "eval <corpus baseline|corpus freeze|corpus verify|corpus review-pack|attest|run|verify>"},
		{name: "unknown eval subcommand", args: []string{"eval", "unknown"}, message: "eval <corpus baseline|corpus freeze|corpus verify|corpus review-pack|attest|run|verify>"},
		{name: "missing eval corpus subcommand", args: []string{"eval", "corpus"}, message: "eval <corpus baseline|corpus freeze|corpus verify|corpus review-pack|attest|run|verify>"},
		{name: "unknown eval corpus subcommand", args: []string{"eval", "corpus", "unknown"}, message: "eval <corpus baseline|corpus freeze|corpus verify|corpus review-pack|attest|run|verify>"},
